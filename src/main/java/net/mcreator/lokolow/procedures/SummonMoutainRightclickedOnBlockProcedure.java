...
public class SummonMoutainRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (world instanceof ServerLevel _serverworld) {
			StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("lokolow", "montanha_russa_lokolow"));
			if (template != null) {
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(LokolowModItems.SUMMON_MOUTAIN.get());
