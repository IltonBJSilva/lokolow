...
public class LokolowInversoEntity extends Zombie {
	...
	public LokolowInversoEntity(EntityType<LokolowInversoEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(LokolowModEntities.LOKOLOW_INVERSO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
