...
public class LokolowEntity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(LokolowModEntities.LOKOLOW.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
