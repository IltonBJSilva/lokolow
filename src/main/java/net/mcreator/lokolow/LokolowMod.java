...
@Mod("lokolow")
public class LokolowMod {
	public static final Logger LOGGER = LogManager.getLogger(LokolowMod.class);
	public static final String MODID = "lokolow";
